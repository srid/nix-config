...
myLayout = avoidStruts $ smartBorders $ layoutHook desktopConfig ||| threeColumns ||| multiCol [2] 2 0.01 0.4 ||| Full
...
myConfig = ewmh def
    ...
    , ("M-C-j", namedScratchpadAction scratchpads "keep")
...
scratchpads = [ scratchChromeApp "wrinkle" "internal.wrinkl.obsidian.systems"
              ...
              , scratchChromeApp "keep" "keep.google.com"
